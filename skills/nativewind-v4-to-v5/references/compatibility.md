...
Compatibility notes for the published Expo 57 RC0. This document describes library contracts; application migration verification is reported separately.

The target is Expo 57.0.22 with React Native 0.86.3, React 19.2.3, Reanimated 4.5.1 and Worklets 0.10.1. The published package pair is Nativewind 5.0.0-rc.0 and react-native-css 3.1.0-rc.0. Use that exact pair together.
