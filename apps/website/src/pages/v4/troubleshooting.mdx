...
If you are still receiving this error after including the preset, you most likely have another preset or plugin overriding the `jsxImportSource`. If so, explictly set the options of `@babel/plugin-transform-react-jsx` within your `plugins` array.
