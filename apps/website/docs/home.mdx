...
NativeWind uses [Tailwind CSS](https://tailwindcss.com) to create a **modern style engine** for React Native.

NativeWind components can be shared between platforms and will use CSS StyleSheet on web and StyleSheet.create for native.
...
🔥 **Features** dark mode / arbitrary classes / media queries / themes / custom values / plugins
