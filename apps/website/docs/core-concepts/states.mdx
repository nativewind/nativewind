...
React Native 0.71 supports opt-in [Pointer Events](https://reactnative.dev/blog/2023/01/12/version-071#events). If enabled NativeWind will use these instead, allowing for hover support on native.
...
<Compatibility none={["portrait:", "landscape:"]} legend={false} />
...
<details><summary>We are looking for contributors for the following</summary>
