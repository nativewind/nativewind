import { AnimationIterationCount, EasingFunction as CSSEasingFunction, Declaration, KeyframesRule } from "lightningcss";

import { EasingFunction, RawAnimation } from "../runtime/pure/reanimated";
...
import { StyleDeclaration } from "../runtime/pure";
...
export function parseEasingFunction(value: CSSEasingFunction[]): EasingFunction[] {
  return value.map((value) => {
  switch (value.type) {
    case "linear":
    case "ease":
